...
if __name__ == '__main__':
	...
	for run in range(runs):
		...
		if model_type=='VAE':
			...
			save_path,result_folder=GAN_train(train_dbs,epochs=train_epochs,learning_rate=0.0005,batchsize=batchsize,h_dimG=513,L1G=100,L2G=513,L1D=90,optimizer='RMSprop',data_info=data_info )
